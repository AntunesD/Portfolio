  ...
  return (
    <section>
      <div>
        ...
        <pre><code className="language-shell hljs"  >npm install redux
        </code></pre>
        <pre><code className="language-shell hljs"  > npm install @reduxjs/toolkit
        </code></pre>
...
export const apiRequest = async (method, url, token, data = null) => {
    ...
    try {
      ...
      throw error;
        ...
        <img className="swagger" src="./Image/ArgentBank/Swagger.webp" alt="swagger" />
        <p>
